...
$t02_kelas_grid = NULL; // Initialize page object first

class ct02_kelas_grid extends ct02_kelas {
	...
	// Page object name
	var $PageObjName = 't02_kelas_grid';

	// Grid form hidden field names
	var $FormName = 'ft02_kelasgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t02_kelas"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "t01_sekolah") {
			...
			if ($GLOBALS["t01_sekolah"]->EventCancelled) $this->EventCancelled = TRUE;
		}
