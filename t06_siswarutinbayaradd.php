...
$t06_siswarutinbayar_add = NULL; // Initialize page object first

class ct06_siswarutinbayar_add extends ct06_siswarutinbayar {
	...
	// Page object name
	var $PageObjName = 't06_siswarutinbayar_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t06_siswarutinbayarlist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t06_siswarutinbayarview.php")
...
// Create page object
if (!isset($t06_siswarutinbayar_add)) $t06_siswarutinbayar_add = new ct06_siswarutinbayar_add();

// Page init
$t06_siswarutinbayar_add->Page_Init();

// Page main
$t06_siswarutinbayar_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t06_siswarutinbayar_add->Page_Render();
?>
...
var CurrentForm = ft06_siswarutinbayaradd = new ew_Form("ft06_siswarutinbayaradd", "add");

// Validate form
ft06_siswarutinbayaradd.Validate = function() {
...
ft06_siswarutinbayaradd.Form_CustomValidate = 
...
ft06_siswarutinbayaradd.ValidateRequired = true;
<?php } else { ?>
ft06_siswarutinbayaradd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft06_siswarutinbayaradd.Lists["x_tahunajaran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_tahun_pelajaran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"v00_tahunajaran"};
ft06_siswarutinbayaradd.Lists["x_sekolah_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nomor_Induk","x_Nama","",""],"ParentFields":[],"ChildFields":["x_kelas_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t01_sekolah"};
ft06_siswarutinbayaradd.Lists["x_kelas_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":["x_sekolah_id"],"ChildFields":[],"FilterFields":["x_sekolah_id"],"Options":[],"Template":"","LinkTable":"t02_kelas"};
ft06_siswarutinbayaradd.Lists["x_siswa_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nomor_Induk","x_Nama","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t03_siswa"};
ft06_siswarutinbayaradd.Lists["x_rutin_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t04_rutin"};
ft06_siswarutinbayaradd.Lists["x_Bulan"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft06_siswarutinbayaradd.Lists["x_Bulan"].Options = <?php echo json_encode($t06_siswarutinbayar->Bulan->Options()) ?>;
ft06_siswarutinbayaradd.Lists["x_Tahun"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft06_siswarutinbayaradd.Lists["x_Tahun"].Options = <?php echo json_encode($t06_siswarutinbayar->Tahun->Options()) ?>;
...
<?php } ?>
<?php $t06_siswarutinbayar_add->ShowPageHeader(); ?>
<?php
$t06_siswarutinbayar_add->ShowMessage();
?>
<form name="ft06_siswarutinbayaradd" id="ft06_siswarutinbayaradd" class="<?php echo $t06_siswarutinbayar_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t06_siswarutinbayar_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t06_siswarutinbayar_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("ft06_siswarutinbayaradd", "x_Bayar_Tgl", 7);
</script>
<?php } ?>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t06_siswarutinbayar_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft06_siswarutinbayaradd.Init();
</script>
<?php
$t06_siswarutinbayar_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t06_siswarutinbayar_add->Page_Terminate();
?>
