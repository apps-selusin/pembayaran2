...
$RootMenu->AddMenuItem(24, "mci_Pembayaran", $Language->MenuPhrase("24", "MenuText"), "", 6, "", IsLoggedIn(), FALSE, TRUE);
$RootMenu->AddMenuItem(13, "mi_t04_rutin", $Language->MenuPhrase("13", "MenuText"), "t04_rutinlist.php", 24, "", AllowListMenu('{8F2DFBC1-53BE-44C3-91F5-73D45F821091}t04_rutin'), FALSE, FALSE);
