...
$t00_tahunajaran = NULL;

//
// Table class for t00_tahunajaran
//
class ct00_tahunajaran extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't00_tahunajaran';
		$this->TableName = 't00_tahunajaran';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t00_tahunajaran`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t00_tahunajaran', 't00_tahunajaran', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// awal_bulan
		$this->awal_bulan = new cField('t00_tahunajaran', 't00_tahunajaran', 'x_awal_bulan', 'awal_bulan', '`awal_bulan`', '`awal_bulan`', 16, -1, FALSE, '`awal_bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->awal_bulan->Sortable = TRUE; // Allow sort
		$this->awal_bulan->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->awal_bulan->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->awal_bulan->OptionCount = 12;
		$this->fields['awal_bulan'] = &$this->awal_bulan;

		// awal_tahun
		$this->awal_tahun = new cField('t00_tahunajaran', 't00_tahunajaran', 'x_awal_tahun', 'awal_tahun', '`awal_tahun`', '`awal_tahun`', 2, -1, FALSE, '`awal_tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// akhir_bulan
		$this->akhir_bulan = new cField('t00_tahunajaran', 't00_tahunajaran', 'x_akhir_bulan', 'akhir_bulan', '`akhir_bulan`', '`akhir_bulan`', 16, -1, FALSE, '`akhir_bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->akhir_bulan->Sortable = TRUE; // Allow sort
		$this->akhir_bulan->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->akhir_bulan->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->akhir_bulan->OptionCount = 12;
		$this->fields['akhir_bulan'] = &$this->akhir_bulan;

		// akhir_tahun
		$this->akhir_tahun = new cField('t00_tahunajaran', 't00_tahunajaran', 'x_akhir_tahun', 'akhir_tahun', '`akhir_tahun`', '`akhir_tahun`', 2, -1, FALSE, '`akhir_tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t00_tahunajaran`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t00_tahunajaranlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t00_tahunajaranview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t00_tahunajaranview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t00_tahunajaranadd.php?" . $this->UrlParm($parm);
		else
			$url = "t00_tahunajaranadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t00_tahunajaranedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t00_tahunajaranadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t00_tahunajarandelete.php", $this->UrlParm());
	}
