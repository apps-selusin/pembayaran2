...
<?php if ($t06_siswarutinbayar->id->Visible) { // id ?>
		<th><span id="elh_t06_siswarutinbayar_id" class="t06_siswarutinbayar_id"><?php echo $t06_siswarutinbayar->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t06_siswarutinbayar->siswarutin_id->Visible) { // siswarutin_id ?>
		<th><span id="elh_t06_siswarutinbayar_siswarutin_id" class="t06_siswarutinbayar_siswarutin_id"><?php echo $t06_siswarutinbayar->siswarutin_id->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($t06_siswarutinbayar->id->Visible) { // id ?>
		<td<?php echo $t06_siswarutinbayar->id->CellAttributes() ?>>
<span id="el<?php echo $t06_siswarutinbayar_delete->RowCnt ?>_t06_siswarutinbayar_id" class="t06_siswarutinbayar_id">
...
<?php } ?>
<?php if ($t06_siswarutinbayar->siswarutin_id->Visible) { // siswarutin_id ?>
		<td<?php echo $t06_siswarutinbayar->siswarutin_id->CellAttributes() ?>>
<span id="el<?php echo $t06_siswarutinbayar_delete->RowCnt ?>_t06_siswarutinbayar_siswarutin_id" class="t06_siswarutinbayar_siswarutin_id">
