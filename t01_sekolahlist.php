...
<?php if ($t01_sekolah->Nomor_Induk->Visible) { // Nomor_Induk ?>
	...
	<?php } else { ?>
		<th data-name="Nomor_Induk"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t01_sekolah->SortUrl($t01_sekolah->Nomor_Induk) ?>',2);"><div id="elh_t01_sekolah_Nomor_Induk" class="t01_sekolah_Nomor_Induk">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $t01_sekolah->Nomor_Induk->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($t01_sekolah->Nomor_Induk->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($t01_sekolah->Nomor_Induk->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
