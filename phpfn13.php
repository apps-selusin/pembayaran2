...
function CurrentProjectID() {
	...
	return "{8F2DFBC1-53BE-44C3-91F5-73D45F821091}";
}
...
function Database_Connecting(&$info) {
	...
	if (ew_CurrentUserIP () == "127.0.0.1"  || ew_CurrentUserIP () == ":: 1"  || ew_CurrentHost () == "localhost" ) { // testing on local PC
		...
		$info["db"] = "db_pembayaran2"; // sesuaikan dengan nama database di komputer localhost
	} elseif (ew_CurrentHost () == "pembayaran2.nma-indonesia.com") { // setting koneksi database untuk komputer server
		$info["host"] = "mysql.idhostinger.com";  // sesuaikan dengan ip address atau hostname komputer server
		$info["user"] = "u945388674_pemba"; // sesuaikan dengan username database di komputer server
		$info["pass"] = "M457r1P 81"; // sesuaikan deengan password database di komputer server
		$info["db"] = "u945388674_pemba"; // sesuaikan dengan nama database di komputer server
	}
}
